...
func (u *Upgrader) upgradeSchema9to10() (err error) {
	...
	if !exists {
		...
		// maybe index and maybe add a swap bool col to transactions table?
	...
	// swapStmt, err := dbTx.Prepare(internal.InsertContractSpend)
	// if err != nil {
	// 	return makeErr("failed to prepare swap insert statement: %v", err)
	// }
